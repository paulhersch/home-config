...
-- local statusline_string = concat(module_list)

-- setmetatable(module_list, {
--     __newindex = function (table, key, value)
--         table[key] = value
--         statusline_string = concat(module_list)
--     end
-- })
...
a.nvim_create_autocmd({"FileChangedShellPost", "CursorMoved", "CursorMovedI", "BufWritePost"}, {
    callback = function ()
