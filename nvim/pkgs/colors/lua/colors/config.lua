...
local function config(colors)
    ...
    return {
        ...
        CmpItemKindKeyword = { bg = colors.fg_for_color_bg, fg = colors.color22 },
        CmpItemKindVariable = { fg = colors.color19 },
        CmpItemKindFunction = { fg = colors.color20 },
        CmpItemKindMethod = { link = "CmpItemKindFunction" },
        CmpItemKindText = { link = "CmpItemKindKeyword" },
        CmpItemKindEnum = { fg = colors.color20 },
        CmpItemKindProperty = { fg = colors.color18 },
        CmpItemKindConstructor = { fg = colors.color21 },
        CmpItemKindField = { fg = colors.color16 },
        CmpItemKindClass = { link = "CmpItemKindEnum" },
        CmpItemKindInterface = { fg = colors.color20 },
        CmpItemKindModule = { fg = colors.color23 },
        CmpItemKindSnippet = { fg = colors.color17 },
        CmpItemKindStruct = { link = "CmpItemKindConstructor" },
        CmpItemKindConst = { link = "CmpItemKindProperty" },
        CmpItemKindEvent = { fg = colors.color19 },
