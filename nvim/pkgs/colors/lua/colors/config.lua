...
local function config(colors)
    ...
    return {
        ...
        CmpItemKindKeyword = { fg = colors.fg_for_color_bg, bg = colors.color22 },
        CmpItemKindVariable = { fg = colors.fg_for_color_bg, bg = colors.color19 },
        CmpItemKindFunction = { fg = colors.fg_for_color_bg, bg = colors.color20 },
        CmpItemKindMethod = { link = "CmpItemKindFunction" },
        CmpItemKindText = { link = "CmpItemKindKeyword" },
        CmpItemKindEnum = { fg = colors.fg_for_color_bg, bg = colors.color20 },
        CmpItemKindProperty = { fg = colors.fg_for_color_bg, bg = colors.color18 },
        CmpItemKindConstructor = { fg = colors.fg_for_color_bg, bg = colors.color21 },
        CmpItemKindField = { fg = colors.fg_for_color_bg, bg = colors.color16 },
        CmpItemKindClass = { link = "CmpItemKindEnum" },
        CmpItemKindInterface = { fg = colors.fg_for_color_bg, bg = colors.color20 },
        CmpItemKindModule = { fg = colors.fg_for_color_bg, bg = colors.color23 },
        CmpItemKindSnippet = { fg = colors.fg_for_color_bg, bg = colors.color17 },
        CmpItemKindStruct = { link = "CmpItemKindConstructor" },
        CmpItemKindConst = { link = "CmpItemKindProperty" },
        CmpItemKindEvent = { fg = colors.fg_for_color_bg, bg = colors.color19 },
