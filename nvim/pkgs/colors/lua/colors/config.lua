...
local function config(colors)
    ...
    return {
        ...
        SpellBad = { fg = colors.color2, undercurl = true },
        SpellCap = { fg = colors.color6, undercurl = true },
        SpellLocal = { fg = colors.color4, undercurl = true },
        SpellRare = { fg = colors.color6, undercurl = true },
        ...
        WildMenu = { fg = colors.color7, bg = colors.color20 },
        ...
        Ignore = { fg = colors.color0, bg = colors.background },
        ...
        ["@text.strong"] = { fg = colors.color0, bold = true },
        ["@text.emphasis"] = { italic = true, fg = colors.color0 },
        ["@text.underline"] = { fg = colors.foreground, underline = true },
        ["@text.strike"] = { fg = colors.color0, strikethrough = true },
        ...
        TabLineSelFileStat = { fg = colors.comment, bg = colors.background },
        TabLineFill = { fg = "NONE", bg = colors.inactive_tabs },
        TabLineCloseLabel = { fg = colors.foreground, bg = colors.color17 },
        TabLineCloseTabLabel = { fg = colors.color17, bg = colors.background_dark },
        TabLineSelCloseTabLabel = { fg = colors.color17, bg = colors.background },
        ...
        StatusLineModeText = { fg = colors.fg_for_color_bg, bg = colors.comment },
        StatusLineModeNormal = { fg = colors.fg_for_color_bg, bg = colors.color18 },
        StatusLineModeInsert = { fg = colors.fg_for_color_bg, bg = colors.color20 },
        StatusLineModeVisual = { fg = colors.fg_for_color_bg, bg = colors.color21 },
        StatusLineModeReplace = { fg = colors.fg_for_color_bg, fg = colors.color16 },
        StatusLineModeCmd = { fg = colors.fg_for_color_bg, bg = colors.color19 },
        StatusLineModeTerminal = { fg = colors.fg_for_color_bg, bg = colors.color19 },
        StatusLineLSPServers = { fg = colors.comment, bg = colors.inactive_tabs, --[[ italic = true ]] },
        StatusLineGitBranch = { fg = colors.color5, bg = colors.inactive_tabs },
        ...
        CmpItemMenu = { fg = colors.comment, italic = true, bg = "NONE" },
        CmpItemKindKeyword = { fg = colors.color14 },
        CmpItemKindVariable = { fg = colors.color11 },
        CmpItemKindFunction = { fg = colors.color12 },
        CmpItemKindMethod = { link = "CmpItemKindFunction" },
        CmpItemKindText = { link = "CmpItemKindKeyword" },
        CmpItemKindEnum = { fg = colors.color12 },
        CmpItemKindProperty = { fg = colors.color10 },
        CmpItemKindConstructor = { fg = colors.color13 },
        CmpItemKindField = { fg = colors.color15 },
        CmpItemKindClass = { link = "CmpItemKindEnum" },
        CmpItemKindInterface = { fg = colors.color12 },
        CmpItemKindModule = { fg = colors.color15 },
        CmpItemKindSnippet = { fg = colors.color9 },
        CmpItemKindStruct = { link = "CmpItemKindConstructor" },
        CmpItemKindConst = { link = "CmpItemKindProperty" },
        CmpItemKindEvent = { fg = colors.color11 },
        ...
        LspInlayHint = { fg = colors.color23 },

        -- Diagnostic
        DiagnosticVirtualTextError = { fg = colors.color9, bg = colors.background_dark },
        DiagnosticVirtualTextWarn = { fg = colors.color11, bg = colors.background_dark },
        DiagnosticVirtualTextInfo = { fg = colors.color12, bg = colors.background_dark },
        DiagnosticVirtualTextHint = { fg = colors.color10, bg = colors.background_dark },
        DiagnosticError = { fg = colors.color9 },
        DiagnosticWarn = { fg = colors.color11 },
        DiagnosticInfo = { fg = colors.color12 },
        DiagnosticHint = { fg = colors.color10 },
        DiagnosticCode = { fg = colors.color15, italic = true },
        ...
        GitSignsDelete = { bg = colors.background, fg = colors.color17 },
        ...
        TelescopePromptTitle = { bg = colors.color18, fg = colors.fg_for_color_bg },
        ...
        TelescopePreviewTitle = { bg = colors.color17, fg = colors.fg_for_color_bg },
        ...
        DashboardHeader = { fg = colors.color0 },
        DashboardIcon = { fg = colors.color4 },
        DashboardKey = { fg = colors.color9 },
        DashboardDesc = { fg = colors.color8 },
        DashboardCenter = { fg = colors.color4 },
        DashboardShortCut = { fg = colors.color2 },
        DashboardFooter = { fg = colors.comment },
        DashboardEmphasized = { fg = colors.color12, bold = true, underline = true },
        ...
        -- NeoTree
        NeoTreeIndentMarker = { fg = colors.color0, bg = colors.background_dark },
        NeoTreeWinSeparator = { fg = colors.background_dark, bg = colors.background_dark },
        NeoTreeVertSplit = { fg = colors.background_dark, bg = colors.background_dark },
        NeoTreeNormal = { fg = colors.foreground, bg = colors.background_dark },
        NeoTreeNormalNC = { fg = colors.foreground, bg = colors.background_dark },
        ...
        NeoTreeGitUnstaged = { link = "DiffChange" },
        NeoTreeGitUntracked = { link = "DiffChange" },
        NeoTreeGitStaged = { fg = colors.color10 },
        NeoTreeTabInactive = { fg = colors.color15, bg = colors.inactive_tabs },
        NeoTreeTabActive = { fg = colors.foreground, bg = colors.background },
        NeoTreeTabSeparator = { link = "NeoTreeNormal" },
        NeoTreeCursorLine = { bold = false },
        NeoTreeTitleBar = { fg = colors.foreground },
